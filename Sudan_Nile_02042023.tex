...
70\% of the territory of Sudan belongs to the Nile basin \cite{Melesse} with 5 \hl{out of the} the \hl{6} Cataracts of \hl{the }Nile located within Sudan (Figure \ref{fig01}). Moreover, roughly 2/3 of the territory of \hl{the }Nile lies within Sudan with its major tributaries -- the While Nile and Blue Nile -- joining \hl{near }Khartoum \cite{Hamad}. Hence, the specifics of the Khartoum region \hl{are tightly} connected to the Nile River system and the confluence of the White Nile and Blue Nile, Figure \ref{fig02}. The \hl{impact} the Nile River \hl{on} the environment \hl{includes} occasional floods, soil erosion and succession of vegetation on the islands and banks \cite{Halwagy}\hl{,} accumulation of sedimentation \cite{BILLI201012}, \hl{or} growth of aquatic \hl{weeds} \cite{PACINI2016242}. \hl{While providing} a specific \hl{place} for wetland habitat \hl{of} rare species\hl{, the Nile river is also essential water artery of the country, and plays multiple} crucial \hl{roles.} \hl{It is a source of }hydropower \hl{in} Sudan \cite{AYIK20232229}\hl{, an important transport waterway, and provides} water resources for 85\% \hl{of the} population and irrigated agriculture \cite{Kauetal2023}. 
