...
\hl{The satellite images were selected from the United States Geological Survey (USGS) EarthExplorer repository} (\href{https://earthexplorer.usgs.gov/}{https://earthexplorer.usgs.gov/}). \hl{The choice of the data is explained by the availability of the Landsat OLI/TIRS scenes, high resolution across the multispectral bands (channels 1 to 7) with 30 m, open availability of the cloud-free images (0\% of cloudiness) and regular survey of the Landsat which provides the comparable gap between the target years (2013 and 2022) where the images were collected for analysis of changes in vegetation} (Figure \ref{fig03}). \hl{The images were taken within the 5 year gap between December 2013 and December 2018, and 4 year gap between December 2018 and December 2022 which gives the comparable intervals of the periods between the scenes for analysis of vegetation changes. Since the Landsat 8 OLI/TIRS was launched on February 11, 2013, there is no earlier images for Landsat 8 OLI/TIRS and the earliest possible date for December month was December 2013.}
...
\appendixstart
\appendix
\section[\appendixname~\thesection]{Metadata on the Landsat 8-9 OLI/TIRS images}
...
\begin{tabularx}{\fulllength}{l|l|l|l}
    \hline
        \textbf{Data Set Attribute} & \textbf{Attributes for image 2022/12/21} & \textbf{Attributes for 2018/12/18} & \textbf{Attributes for 2013/12/20} \\ \hline
