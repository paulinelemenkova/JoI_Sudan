...
\Title{Satellite-Derived Vegetation Indices Computed by R to Estimate the Desertification in the Khartoum Region of Sudan, Africa}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Satellite-Derived Vegetation Indices Computed by R to Estimate the Desertification in the Khartoum Region of Sudan, Africa}
...
\abstract{Desertification is one of the most destructive climate-related issues in Sudan-Sahel region of Africa. Rising temperatures, declining rainfall, decreased relative humidity, and changes in patterns of cloudiness, atmospheric radiation and evaporation triggered environmental degradation and affected vegetation growth and health. The assessment of desertification is possible by remote sensing data analysis using Vegetation Indices (VIs). The VIs are employed to estimate the level of leaf chlorophyll in plants and thus can be used as robust indicators of plant health and greenness. The VIs present reflect the functional features of canopy and parameters of vegetation coverage that is essential for environmental and climate analytics. The Earth observing satellite sensors providing remote sensing data enable to highlight the links between the hydrological and climate processes leading to desertification and vegetation responses. In this study, we calculated several VIs to compare the status and dynamics of the vegetation in the region of confluence of the Blue Nile and White Nile in Khartoum, southern Sudan. The data were compared for the periods of 2013, 2018 and 2022. We tested five VIs for the Landsat 8-9 OLI/TIRS images: 1) Normalized Difference Vegetation Index (NDVI), 2) Normalized Difference Water Index (NDWI), 3) Red-Edge Chlorophyll Vegetation Index (RECl), 4) Optimized Soil Adjusted Vegetation Index (OSAVI) and 5) Green Normalized Difference Vegetation Index (GNDVI). The demonstrated difference in the VIs collected with nine year time gap reveals climate–vegetation relationships. Further, using programming methods for computing and visualization of VIs presents new challenges for image processing such as the Landsat 8-9 OLI/TIRS scenes. We demonstrated technical advantages of R scripts and packages 'raster' and 'terra'  for spatial data processing to automate image analysis and mapping. Climatic drivers of desertification affecting plant growth and health varied for images taken on different years for 2013, 2018 and 2022 in the confluence of the Blue Nile and White Nile, southern Sudan.}
