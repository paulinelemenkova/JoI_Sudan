...
The NDVI is computed using Equation \ref{eq:1}  \cite{1974NASSP}:
...
The GNDVI is computed using Equation \ref{eq:5}:

\begin{equation}\label{eq:5}
GNDVI=\dfrac{(NIR-Green)}{(NIR+Green)}
\end{equation}

For the Landsat bands, the Blue channel corresponds to the Band 2, Green -- Band 3 and Red -- Band 4. 
