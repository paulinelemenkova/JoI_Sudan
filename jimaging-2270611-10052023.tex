...
xleftmargin=-0em,xrightmargin=4em
}
...
\caption{\hl{Metadata} %MDPI: Please add the explanation for superscript ``1''.
 on the Landsat OLI/TIRS satellite images used in this study \textsuperscript{1}.\label{tabApp}}
\begin{adjustwidth}{-\extralength}{0cm}
...
\newblock 4---Impact of Vegetation Cover Changes on Gum Arabic Production Using
  ...
  Mariod, A.A., Ed.; Academic Press: \hl{Cambridge, MA, USA,} %We added the location of publisher. Please confirm
 2018; \mbox{pp. 29--43}.
...
\newblock \hl{Phanerozoic Geology of Egypt,} %MDPI: can it be deleted?
...
\newblock {\em  Egypt. J. Remote Sens. Space Sci.} {\bf
  2017}, {\em 20},~S21--S29.
\newblock \hl{Water Scarcity and Harvesting,} 
...
\newblock In {\em Modeling Earth Systems and Environment}; \hl{Publisher: City, Country}, 2023; %MDPI: Please add the name of the publisher and their location.
...
\newblock \hl{Larger Asian Rivers: Climate Change, River Flow, and Watershed
  Management,} 
...
\newblock \hl{Ecohydrology of large rivers,} 
...
\newblock Preliminary assessment of small hydropower potential using the Soil
  and Water Assessment Tool model: A case study of Central Equatoria State,
  South Sudan.
...
\bibitem[Sulieman et~al.(2010)]{sulieman2010expansion}
Sulieman, H.M.;  \hl{et~al.} %MDPI: Please include the first ten authors' names before using "et al." in the references.
...
\newblock In {\em The Wiley‐Blackwell Encyclopedia of Globalization}; John
  Wiley \& Sons, Ltd.: \hl{Hoboken, NJ, USA,} %We added the location of publisher. Please confirm
  2013; pp. 1--10.
...
\newblock \hl{The Quaternary History of the River Nile,} 
...
\newblock \hl{Adaptation to Climate Change: Perspectives Across Scales,} 
...
\newblock From vision to action: Towards a national policy for integrated water
  ...
  Management and Policy}; Developments in Water Science; Alsharhan, A.S., Wood, W.W., Eds.; Elsevier: \hl{Amsterdam, The Netherlands,} %We added the location of publisher. Please confirm
  2003;
...
\newblock \hl{Landsat 8 Science Results,} 
...
\newblock In {\em Arabian Journal for Science and Engineering}; \hl{Publisher: City, Country}, 2023; %MDPI: Please add the name of the publisher and their location.
...
\newblock {\em Irrig. Drain.} {\bf 2023}, \hl{volume, page.} %MDPI: Please add the volume and pages.
...
\newblock In \emph{Proceedings of the Cybernetics Perspectives in Systems}; Silhavy,
  R., Ed.; \hl{Publisher: Cham, Switzerland,} %MDPI: Please add the publisher.
 2022; pp. 41--53.
...
\newblock \hl{Collection 2 Landsat 8-9 OLI (Operational Land Imager) and TIRS
...
\newblock  Available online: \url{https://cran.r-project.org/web/packages/RColorBrewer/index.html}  \hl{(accessed on Date Month Year).} %MDPI: Please add the access date (format: Date Month Year), e.g., accessed on 1 January 2020.


\bibitem[{Harrell Jr.}(2023)]{Hmisc}
{Harrell}, F.E., Jr.
\newblock Hmisc: Harrell Miscellaneous. Version: 5.0-1. 2023.
\newblock Available online: \url{https://hbiostat.org/R/Hmisc/}  \hl{(accessed on Date Month Year).} %MDPI: Please add the access date (format: Date Month Year), e.g., accessed on 1 January 2020.


\bibitem[Wright(2021)]{Wright}
Wright, K.
\newblock Pals. License GPL-3. 2021.
\newblock Available online: \url{https://kwstat.github.io/pals/}  \hl{(accessed on Date Month Year).} %MDPI: Please add the access date (format: Date Month Year), e.g., accessed on 1 January 2020.
...
{RStudio Team}.
\newblock RStudio, PBC. In {\em RStudio: Integrated Development for R}; \hl{Publisher: Boston, MA, USA,} %MDPI: Please add the publisher.
 2020.
\newblock  Available online: \url{http://www.rstudio.com/}  \hl{(accessed on Date Month Year).} %MDPI: Please add the access date (format: Date Month Year), e.g., accessed on 1 January 2020. 

\bibitem[Dictionary(2023)]{Dictionary}
Dictionary.
\newblock Biology Online. 2023.
\newblock Available online: \url{https://www.biologyonline.com/dictionary/vigor}  \hl{(accessed on Date Month Year).} %MDPI: Please add the access date (format: Date Month Year), e.g., accessed on 1 January 2020.
