...
We provide in Table \ref{tab02} for each set of images their VI values for years 2013, 2018 and 2022, derived from the R report on data analysis, as it appears in the output console. These values were collected and summarised in Table \ref{tab02} for comparison of variations in the VI's values. In the second to fourth columns we indicate the years of observations and output results obtained by R 'terra' library algorithm. 
