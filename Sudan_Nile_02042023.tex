...
\hl{The images were selected for the availability of the Landsat OLI/TIRS scenes with strict requirements on cloudiness  (0\%) and comparable distance between the years for analysis of changes in vegetation. Thus, images are taken with 5 years gap is between December 2013 and December 2018, and 4 years between December 2018 and December 2022 which gives the comparable intervals of periods between the scenes for analysis of vegetation changes. Since the Landsat 8 OLI/TIRS was launched on February 11, 2013, there is no earlier images for Landsat 8 OLI/TIRS.} The summary of the data is presented in Table \ref{tab1}; all images have 0\% cloudiness. 
