...
\subsubsection{Visible Atmospherically Resistant Index (VARI)}

The VARI is computed using Equation \ref{eq:5}:

\begin{equation}\label{eq:5}
VARI=\dfrac{(Green-Red)}{(Green+Red-Blue)}
\end{equation}
