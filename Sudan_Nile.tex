...
Social factors of desertification include a complex chain of processes related to land management, agriculture policymaking and governance \cite{KOBAYASHI2020257}. Thus, agriculture and livestock raising play an important role in the economy of Sudan as the major sources of livelihood for inhabitants. However, unsustainable agricultural expansion and farming activities also contribute to the increase of desertification \cite{Ibrahim}. For instance, soil erosion, exceed in irrigation, compaction and nutrient depletion, increase in pesticides \cite{Nesser}, as well as overgrazing of cattle are some of the results of the uncontrolled agriculture human activities that have serious effects on land structure and changed land cover types \cite{Ahmed}. In turn, social consequences of desertification in Sudan result in the increased possibility of the severe drought and associated famine due to affected food production and soil degradation in the Sahelian zone of the Sudan \cite{Subramaniam}. 
...
The importance of Nile River Basin can be illustrated by the fact that roughly 2/3 of its territory lies within Sudan and that its major tributaries -- the While Nile and Blue Nile -- confluence near Khartoum, the capital of Sudan \cite{Hamad}. Intense practice of urban agriculture in Khartoum aims at meeting the increasing food demand of the rapidly growing population \cite{SCHUMACHER2009399} which necessarily results in additional pressure on the environment on the one hand, and the gradual increase of the built-up area on the other. 
