...
The summary of the computed indices for comparison by the year in 2013, 2018 and 2022 is presented in Table \ref{tab02}.

\begin{table}[H] 
\caption{Comparison of the VI values derived from the Landsat 8 OLI/TIRS images over the Khartoum region area for nine-year period  (2013, 2018 and 2022).\label{tab02}}
\newcolumntype{C}{>{\centering\arraybackslash}X}
