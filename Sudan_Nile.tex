...
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.6\textwidth}
		\centering
			\includegraphics[width=0.90\textwidth]{Fig_04a}
		\caption{}
	\end{subfigure}%
	\begin{subfigure}[b]{.6\textwidth}
		\centering
		\includegraphics[width=0.90\textwidth]{Fig_04b}
		\caption{}
	\end{subfigure}%
}\\
\vfill \vspace{1mm}
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.6\textwidth}
		\centering
			\includegraphics[width=0.90\textwidth]{Fig_04c}
		\caption{}
	\end{subfigure}%
	\begin{subfigure}[b]{.6\textwidth}
		\centering
...
\makebox[0.90\linewidth][r]{%
	\begin{subfigure}[b]{.6\textwidth}
		\centering
			\includegraphics[width=0.90\textwidth]{Fig_04e}
		\caption{}
	\end{subfigure}%
	\begin{subfigure}[b]{.6\textwidth}
		\centering
...
The majority of values of the Infrared Percentage Vegetation Index (IPVI) for the area of Sudan, Figure \ref{fig08} lies within very narrow interval of 0.05 to 0.4 which well corresponds with the dominance of sandy dune areas and bare soils in the surrounding deserts. Note that all the values of IPVI are never negative and always positive due to the formula used in computation, which distincts this index from the previous ones.
