...
We suggest that the drivers are climate and hydrological factors such as higher precipitation level or increased water discharge from the Nile but cannot support our surmise with numerical arguments and this pattern should be elucidated in future studies. Since the NDWI is specifically designed to monitor vegetation in drought affected areas such as Sudan, such variations indicate at the increase in both the content of vegetation water because of the strong chlorophyll absorption in SWIR and the structure in plant canopy. 
...
\funding{The publication was funded by the Editorial Office of Journal of Imaging, Multidisciplinary Digital Publishing Institute (MDPI), by providing 100\% discount for the APC of this manuscript.}
